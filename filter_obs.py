...
def main():
    file_path = 'observation_again_rware:rware-tiny-4ag-v2_1.log'  # Replace with your actual file path
    output_dir = 'output_json_again_1'  # Directory to save JSON files
